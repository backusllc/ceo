...
export interface FullWidthHeroSettings {
  topType: 'fullWidth';
  props: FullWidthHeroProps;
}

export interface FullWidthHeroProps {
  imageUrl: string;
  //トップ画像の配置
  ...
  //画像内文言(3行目)
  text3: string;
  mobileFontSize3?: Sprinkles['fontSize'];
  desktopFontSize3?: Sprinkles['fontSize'];
  fontFamily3: string;
  fontWeight3: Sprinkles['fontWeight'];
  fontStyle3: Sprinkles['fontStyle'];
  textDecoration3: Sprinkles['textDecoration'];
  justifyContent3: Sprinkles['justifyContent'];
  alignItems3: Sprinkles['alignItems'];
  lineHeight3: string;
...
export const defaultFullWidthHeroProps: FullWidthHeroProps = {
  imageUrl: "https://demo.tcd-theme.com/tcd088/wp-content/uploads/2021/04/top-slider-1.jpg",
  aspectRatio: '16:9',
  text1: "あなたらしさ、もっと自由に",
